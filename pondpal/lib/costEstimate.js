export const costCategories = {
  ...
  'golden-tench': { label: 'Golden Tench', env: 'pond', isPond: true, needsHeater: false, isSaltwater: false, fishPrice: 12, monthlyFoodPerFish: 2, gallonsPerFish: 50, minGallons: 300, pumpWattPerGallon: 0.08 },
  'sturgeon': { label: 'Sturgeon (advanced keepers)', env: 'pond', isPond: true, needsHeater: false, isSaltwater: false, fishPrice: 60, monthlyFoodPerFish: 8, gallonsPerFish: 1000, minGallons: 3000, pumpWattPerGallon: 0.1 },
  'goldfish-tank': { label: 'Goldfish — Fancy', env: 'indoor', isPond: false, needsHeater: false, isSaltwater: false, fishPrice: 12, monthlyFoodPerFish: 2, gallonsPerFish: 20, minGallons: 20, pumpWattPerGallon: 0.5 },
  ...
  'molly': { label: 'Molly', env: 'indoor', isPond: false, needsHeater: true, isSaltwater: false, fishPrice: 4, monthlyFoodPerFish: 0.5, gallonsPerFish: 3, minGallons: 20, pumpWattPerGallon: 0.6 },
  'platy': { label: 'Platy', env: 'indoor', isPond: false, needsHeater: true, isSaltwater: false, fishPrice: 4, monthlyFoodPerFish: 0.5, gallonsPerFish: 2, minGallons: 10, pumpWattPerGallon: 0.6 },
  'swordtail': { label: 'Swordtail', env: 'indoor', isPond: false, needsHeater: true, isSaltwater: false, fishPrice: 5, monthlyFoodPerFish: 0.5, gallonsPerFish: 3, minGallons: 20, pumpWattPerGallon: 0.6 },
  'zebra-danio': { label: 'Zebra Danio', env: 'indoor', isPond: false, needsHeater: true, isSaltwater: false, fishPrice: 3, monthlyFoodPerFish: 0.5, gallonsPerFish: 1, minGallons: 10, pumpWattPerGallon: 0.6 },
  'harlequin-rasbora': { label: 'Harlequin Rasbora', env: 'indoor', isPond: false, needsHeater: true, isSaltwater: false, fishPrice: 4, monthlyFoodPerFish: 0.5, gallonsPerFish: 1, minGallons: 10, pumpWattPerGallon: 0.6 },
  'dwarf-gourami': { label: 'Dwarf Gourami', env: 'indoor', isPond: false, needsHeater: true, isSaltwater: false, fishPrice: 6, monthlyFoodPerFish: 1, gallonsPerFish: 5, minGallons: 20, pumpWattPerGallon: 0.5 },
  'rainbowfish': { label: 'Rainbowfish', env: 'indoor', isPond: false, needsHeater: true, isSaltwater: false, fishPrice: 8, monthlyFoodPerFish: 1, gallonsPerFish: 4, minGallons: 30, pumpWattPerGallon: 0.6 },
  ...
  'firefish': { label: 'Firefish', env: 'saltwater', isPond: false, needsHeater: true, isSaltwater: true, fishPrice: 25, monthlyFoodPerFish: 1.5, gallonsPerFish: 10, minGallons: 20, pumpWattPerGallon: 0.6 },
  'anthias': { label: 'Anthias', env: 'saltwater', isPond: false, needsHeater: true, isSaltwater: true, fishPrice: 35, monthlyFoodPerFish: 2, gallonsPerFish: 20, minGallons: 55, pumpWattPerGallon: 0.7 },
  'butterflyfish': { label: 'Butterflyfish', env: 'saltwater', isPond: false, needsHeater: true, isSaltwater: true, fishPrice: 45, monthlyFoodPerFish: 2, gallonsPerFish: 40, minGallons: 55, pumpWattPerGallon: 0.7 },
  'cardinalfish': { label: 'Cardinalfish', env: 'saltwater', isPond: false, needsHeater: true, isSaltwater: true, fishPrice: 20, monthlyFoodPerFish: 1.5, gallonsPerFish: 10, minGallons: 20, pumpWattPerGallon: 0.6 },
