...
const allContent = [
  ...
  { title: 'Fish Compatibility Checker', desc: 'Find out if your fish species are compatible before you buy — instant AI analysis of temperament, aggression, and water parameter conflicts.', url: '/tools/compatibility-checker', category: 'Tool', emoji: '🤝', tags: ['compatibility', 'tank mates', 'aggression', 'temperament', 'mixed species', 'stocking', 'koi', 'goldfish', 'cichlid'] },
  { title: 'True Cost of Keeping Fish Calculator', desc: 'Find the real upfront and ongoing cost of keeping koi, goldfish, tropical fish, or a saltwater tank — including equipment, food, and electricity.', url: '/tools/cost-calculator', category: 'Tool', emoji: '💰', tags: ['cost', 'price', 'budget', 'how much does it cost', 'electricity', 'upfront', 'monthly', 'calculator'] },
  { title: 'Fish Photo Diagnosis', desc: "Upload a photo of your fish and get an instant AI assessment of visible symptoms — spots, fin damage, discoloration, and more.", url: '/tools/photo-diagnosis', category: 'Tool', emoji: '📸', tags: ['photo', 'picture', 'diagnosis', 'symptoms', 'sick', 'disease', 'spots', 'fin rot', 'upload', 'image'] },
  ...
  { title: 'African Cichlid Tank Setup Guide', desc: 'How to set up an African cichlid tank — tank size, water chemistry, rockwork, stocking, filtration, and managing aggression in Malawi and Tanganyika cichlid tanks.', url: '/blog/african-cichlid-tank-setup', category: 'Blog', emoji: '📝', tags: ['african cichlid', 'malawi', 'tanganyika', 'mbuna', 'setup', 'aggression', 'rockwork', 'tank size'] },
  { title: 'How to Cycle a Fish Tank for Beginners', desc: "A complete beginner's guide to cycling a fish tank — what the nitrogen cycle is, how long it takes, and exactly how to do it safely before adding fish.", url: '/blog/how-to-cycle-fish-tank', category: 'Blog', emoji: '📝', tags: ['cycle', 'cycling', 'nitrogen cycle', 'new tank', 'beginner', 'ammonia', 'nitrite', 'nitrate', 'how long'] },
  { title: 'What Fish Can Live With Bettas?', desc: 'Which fish can safely live with bettas and which will cause problems. A complete betta tank mate guide with safe options and fish to always avoid.', url: '/blog/what-fish-can-live-with-bettas', category: 'Blog', emoji: '📝', tags: ['betta', 'tank mates', 'compatibility', 'community tank', 'safe fish', 'avoid'] },
  { title: 'How Often Should You Do Water Changes?', desc: "The real answer depends on your setup — stocking, filtration, and feeding all play a part. Here's how to figure out yours.", url: '/blog/how-often-water-changes', category: 'Blog', emoji: '📝', tags: ['water change', 'how often', 'frequency', 'maintenance', 'nitrate', 'schedule'] },
  { title: 'Nitrite Poisoning in Fish — Signs and Treatment', desc: "Nitrite is the second stage of the nitrogen cycle and just as dangerous as ammonia. Here's how to recognize it and treat it fast.", url: '/blog/nitrite-poisoning-fish', category: 'Blog', emoji: '📝', tags: ['nitrite', 'poisoning', 'brown blood disease', 'salt treatment', 'cycling', 'signs', 'treatment'] },
]
