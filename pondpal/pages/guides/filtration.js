  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="A guide to koi pond filtration — gravity filters, bead filters, MBBR, UV sterilizers, and bottom drains explained clearly for all experience levels." />
      </Head>
      ...
      <div style={{ maxWidth: '780px', margin: '0 auto', padding: '3rem 2rem' }}>
        ...
        <div style={{ background: '#062d3a', borderRadius: '14px', padding: '2rem', marginTop: '2rem', textAlign: 'center' }}>
          <h3 style={{ color: '#fff', marginBottom: '0.75rem', fontSize: '1.2rem' }}>Is your current filtration keeping up?</h3>
