    ...
    <>
      ...
      <div style={{ maxWidth: '780px', margin: '0 auto', padding: '3rem 2rem' }}>
        ...
        <div style={{ background: '#fff', borderRadius: '14px', padding: '1.5rem', border: '1px solid rgba(0,0,0,0.07)', marginBottom: '2rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
            {[
              { name: 'API Pond Master Test Kit', desc: 'Test water first when fish look sick', url: 'https://www.amazon.com/dp/B0002IHNUO?tag=pondpal20-20' },
              { name: 'Seachem Prime', desc: 'Reduces stress during disease treatment', url: 'https://www.amazon.com/dp/B00025694O?tag=pondpal20-20' },
              { name: 'API Melafix Pond', desc: 'Treats bacterial infections naturally', url: 'https://www.amazon.com/dp/B0002APNB4?tag=pondpal20-20' },
              { name: 'PraziPro', desc: 'Most effective treatment for flukes', url: 'https://www.amazon.com/dp/B001E8KHDG?tag=pondpal20-20' },
            ].map((p, i) => (
